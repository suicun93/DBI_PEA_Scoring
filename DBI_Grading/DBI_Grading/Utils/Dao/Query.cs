namespace DBI_Grading.Utils.Dao
{
    ...
    {
        public static string ProcCompareDbs = "PROC sp_CompareDb\n" +
                                              "(\n" +
                                              "	@SourceDB SYSNAME,\n" +
                                              "	@TargetDb SYSNAME\n" +
                                              ")\n" +
                                              ...
                                              "		CROSS JOIN (SELECT\n" +
                                              "				'Missing column or Wrong column name' AS Reason) Tab2\n" +
                                              "		UNION ALL\n" +
                                              "		SELECT\n" +
                                              ...
                                              "		CROSS JOIN (SELECT\n" +
                                              "				'Missing Constraint' AS Reason) Tab2\n" +
                                              "		UNION ALL\n" +
                                              "		SELECT\n" +
                                              "			@TargetDb AS DATABASENAME,\n" +
                                              "			TABLE_NAME,\n" +
                                              ...
                                              "\n" +
                                              "	SELECT\n" +
                                              "		DATABASENAME, TABLENAME, COLUMNNAME, DATATYPE, NULLABLE, REASON\n" +
                                              "	FROM #TAB_RESULTS\n" +
                                              "	ORDER BY REASON, TABLENAME, COLUMNNAME, DATABASENAME\n" +
                                              "	\n" +
                                              "	SELECT\n" +
                                              "		DATABASENAME, FK_TABLE AS PK_TABLE, FK_COLUMNS AS PK_COLUMNS, PK_TABLE AS FK_TABLE, PK_COLUMNS AS FK_COLUMNS, REASON\n" +
                                              "	FROM #FK_RESULTS\n" +
                                              "END\n" +
                                              "GO";
    }
