...
namespace DBI_PEA_Scoring.Utils.Dao
{
    internal class SchemaType
    {
        ...
        private static string procCompareDbs = "PROC [dbo].[sp_CompareDb]\n" +
                                                    "(\n" +
                                                    "	@SourceDB SYSNAME,\n" +
                                                    "	@TargetDb SYSNAME\n" +
                                                    ")\n" +
                                                    ...
                                                    "		CROSS JOIN (SELECT\n" +
                                                    "				'Missing or wrong name of Column' AS Reason) Tab2\n" +
                                                    "		UNION ALL\n" +
                                                    "		SELECT\n" +
                                                    ...
                                                    "	SELECT\n" +
                                                    "		DATABASENAME FK_TABLE, FK_COLUMNS, PK_TABLE, PK_COLUMNS, REASON\n" +
                                                    "	FROM #FK_RESULTS\n" +
                                                    "END\n" +
                                                    "GO";


        public static string ProcCompareDbs { get => ProcCompareDbs; set => ProcCompareDbs = value; }
    }
}
